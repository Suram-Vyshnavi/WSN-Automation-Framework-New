...
class CareerBuddyPage(BasePage):
    ...
    def click_location_dropdown_and_apply(self):
        ...
        self.page.locator(careerbuddy_locators.LOCATION_OPTION_BANGALORE).wait_for(state="visible", timeout=10000)
        highlight_element(self.page, careerbuddy_locators.LOCATION_OPTION_BANGALORE)
        self.page.locator(careerbuddy_locators.LOCATION_OPTION_BANGALORE).click()
        self.page.locator(careerbuddy_locators.APPLY_BUTTON).wait_for(state="visible", timeout=10000)
        self.page.locator(careerbuddy_locators.APPLY_BUTTON).click()
