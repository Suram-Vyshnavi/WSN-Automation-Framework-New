...
class HomeDashboardPage(BasePage):
    ...
    def validate_genie_ai(self):
        self._capture_dashboard_url()
        self.page.locator(NewHomepageLocators.VALIDATE_GENIE_AI_BANNER).wait_for(state="visible", timeout=15000)
        highlight_element(self.page, NewHomepageLocators.VALIDATE_GENIE_AI_BANNER)
        self.page.locator(NewHomepageLocators.GENIE_AI_SEARCH_INPUT).fill("Help me choose a career")
        self.page.locator(NewHomepageLocators.SEND_ICON_ARROW).wait_for(state="visible", timeout=25000)
        highlight_element(self.page, NewHomepageLocators.SEND_ICON_ARROW)
        self.page.locator(NewHomepageLocators.SEND_ICON_ARROW).click()
        # self.page.locator(NewHomepageLocators.CAREER_ADVISOR_TOOL).wait_for(state="visible", timeout=25000)
        # highlight_element(self.page, NewHomepageLocators.CAREER_ADVISOR_TOOL)
        # self.page.locator(NewHomepageLocators.CAREER_ADVISOR_TOOL).click()
        # attach_screenshot(self.page, "Career Advisor Tool Page")
        # for i in range(2):
        #     self.page.go_back()
        # self.page.locator(NewHomepageLocators.BROWSE_COURSES).wait_for(state="visible", timeout=15000)
        # highlight_element(self.page, NewHomepageLocators.BROWSE_COURSES)
        # self.page.locator(NewHomepageLocators.BROWSE_COURSES).click()
        # attach_screenshot(self.page, "Browse Courses Page")
        # # self.page.go_back()
        self.page.locator(NewHomepageLocators.SPEAKER_SECTION).wait_for(state="visible", timeout=25000)
        highlight_element(self.page, NewHomepageLocators.SPEAKER_SECTION)
        self.page.locator(NewHomepageLocators.SPEAKER_SECTION).click()
        attach_screenshot(self.page, "Speaker Section Page")
        self.page.locator(NewHomepageLocators.GENIE_RATING_BUTTON).wait_for(state="visible", timeout=25000)
        highlight_element(self.page, NewHomepageLocators.GENIE_RATING_BUTTON)   
        self.page.locator(NewHomepageLocators.GENIE_RATING_BUTTON).click()
        self.page.locator(NewHomepageLocators.ASK_YOUR_QUESTIONS_HERE_TEXTAREA).fill("How to prepare for an interview?")
        self.page.locator(NewHomepageLocators.SEND_MSG_ICON).wait_for(state="visible", timeout=25000)
        highlight_element(self.page, NewHomepageLocators.SEND_MSG_ICON)
        self.page.locator(NewHomepageLocators.SEND_MSG_ICON).click()
        # self.page.locator(NewHomepageLocators.INTERVIEW_COACH).click()
        # self.page.go_back()
        # attach_screenshot(self.page, "Interview Coach Page")
        self.page.locator(NewHomepageLocators.PREVIOUS_CHATS_HEADER).wait_for(state="visible", timeout=25000)
        highlight_element(self.page, NewHomepageLocators.PREVIOUS_CHATS_HEADER)
        self.page.locator(NewHomepageLocators.PREVIOUS_CHATS_HEADER).click()
        self.page.locator(NewHomepageLocators.GENIE_SIDEBAR_TOGGLE_OPEN).wait_for(state="visible", timeout=25000)
        highlight_element(self.page, NewHomepageLocators.GENIE_SIDEBAR_TOGGLE_OPEN)
        self.page.locator(NewHomepageLocators.GENIE_SIDEBAR_TOGGLE_OPEN).click()
        self.page.locator(NewHomepageLocators.NEW_CHAT_HEADER).wait_for(state="visible", timeout=25000)
        highlight_element(self.page, NewHomepageLocators.NEW_CHAT_HEADER)
        self.page.locator(NewHomepageLocators.NEW_CHAT_HEADER).click()
        attach_screenshot(self.page, "New Chat Page")
        self.page.locator(NewHomepageLocators.SUBPAGE_BACK_BUTTON).wait_for(state="visible", timeout=25000)
        highlight_element(self.page, NewHomepageLocators.SUBPAGE_BACK_BUTTON)
        self.page.locator(NewHomepageLocators.SUBPAGE_BACK_BUTTON).click()
        attach_screenshot(self.page, "Back to Dashboard")
        print("Clicked Genie AI banner")
