...
from pages.studentpersona.career_buddy_page import CareerBuddyPage
...
@then("user fills in the session purpose and specific outcome fields, selects the checkbox option and clicks on the Book button")
def fill_session_details_and_book(context):
    career_buddy = CareerBuddyPage(context.page)
    career_buddy.fill_session_details_and_book()
    attach_screenshot(context.page, "Session Details Filled and Booked")
