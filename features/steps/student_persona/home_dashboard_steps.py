...
def click_programs_and_courses_card(context):
    dashboard = HomeDashboardPage(context.page)
    dashboard.click_programs_and_courses_card()
    attach_screenshot(context.page, "Programs & Courses Card Clicked")
...
def click_forums_card(context):
    ...
    if context.feature.name.lower() == "forums" or stays_on_forums:
        from pages.student_persona.forums_page import ForumsPage
