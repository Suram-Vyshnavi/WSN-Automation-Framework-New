...
def step_enter_email(context):
    ...
    if credentials is None:
        return
    CommonSettingsPage(getattr(context, "zoom_page", context.page)).enter_zoom_email(credentials[0])
...
def step_enter_password(context):
    ...
    if credentials is None:
        return
    CommonSettingsPage(getattr(context, "zoom_page", context.page)).enter_zoom_password(credentials[1])
