...
from pages.common_pages.common_activity_insights_page import CommonActivityInsightsPage
...
def _activity_insights_unavailable(context):
    if getattr(context, "activity_insights_unavailable", False):
        log.warning("Skipping activity insights step — tab unavailable for this batch.")
        return True
    return False
