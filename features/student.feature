Feature: Student Persona
  Scenario: Homepage dashboard Validation
  ...
  Scenario: Validate courses card on homepage dashboard
    Given user is on the home page
    Then user validates the home icon
    Then user validates the welcome header and wadhwani skilling header
    Then user clicks on courses card
  ...
  Scenario: Validate interview coach card on homepage dashboard
    Given user is on the home page
    Then user validates the home icon
    Then user validates the welcome header and wadhwani skilling header
    Then user clicks on interview coach card
  ...
  Scenario: Validate personal pitch card on homepage dashboard
    Given user is on the home page
    Then user validates the home icon
    Then user validates the welcome header and wadhwani skilling header
    Then user clicks on personal pitch trainer card
  ...
  Scenario: Validate programs card on homepage dashboard
    Given user is on the home page
    Then user validates the home icon
    Then user validates the welcome header and wadhwani skilling header
    Then user clicks on programs card
