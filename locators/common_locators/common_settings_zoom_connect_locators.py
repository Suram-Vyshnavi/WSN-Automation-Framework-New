...
class CommonSettingsZoomConnectLocators:
    ...
    ZOOM_SETTINGS_ARROW=f"//*[contains({UPPER}, 'ZOOM') or contains({UPPER}, 'MEETING')]/ancestor::div[contains(@class,'section-container') or contains(@class,'zoom-container') or contains(@class,'item')][1]//img[@alt='right_arrow' or contains(@alt,'arrow')]"
